...
All the pre-trained Fast-iTPN models are available now! The tiny/small/base scale models report the best performance on ImageNet-1K as far as we know. Use them for your tasks!
